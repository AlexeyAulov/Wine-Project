...
<html lang="en">
  ...
  <body>
  <div class=bigger_imagefour>  
      <div class="big_imagefour">
        <div class="overlayfour">
          <h1>Hi Everyone, I am the creator of Alex's Projects!</h1>
          <p> 
            Hello, I am an Information Systems and Informatics major at CUNY College of Staten Island. I am aspiring
            to be a fullstack developer. </p>
            <ul>
              <li>Contact: 718-238-7389</li>
              <li>Email: Alexey.Aulov@cix.csi.cuny.edu</li>
            </ul>
          </div>
    </div>
  </div>
